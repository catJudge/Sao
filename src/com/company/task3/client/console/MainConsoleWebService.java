package com.company.task3.client.console;


import com.company.library.Helper;
import com.company.task3.webService.CalculateWebService;
...
public class MainConsoleWebService {
    ...
    public static void main(String[] args) throws MalformedURLException {
        ...
        QName qname = new QName("http://webService.task3.company.com/", "CalculateWebServiceImplService");
